...
print 'wget -q "http://download.forge.ow2.org/xwiki/xwiki-enterprise-web-' + latest + '.war" -P /'
print 'unzip -q "/xwiki-enterprise-web-' + latest + '.war" -d /var/lib/tomcat7/webapps/xwiki'
print 'rm -f "/xwiki-enterprise-web-' + latest + '.war"'

# forked Jenkins Docker image, based on the official Jenkins-image
...
```
docker run -p 8080:8080 -p 50000:50000 afischer211/jenkins
```
...
```
docker run -p 8080:8080 -p 50000:50000 -v /your/home:/var/jenkins_home afischer211/jenkins
```
...
```
docker run --name myjenkins -p 8080:8080 -p 50000:50000 -v /var/jenkins_home afischer211/jenkins
```
...
```
docker run --name myjenkins -p 8080:8080 -p 50000:50000 --env JAVA_OPTS=-Dhudson.footerURL=http://mycompany.com afischer211/jenkins
```
...
EOF
docker run --name myjenkins -p 8080:8080 -p 50000:50000 --env JAVA_OPTS="-Djava.util.logging.config.file=/var/jenkins_home/log.properties" -v `pwd`/data:/var/jenkins_home afischer211/jenkins
```
...
```
docker run afischer211/jenkins --version
```
...
```
docker run --name myjenkins -p 8080:8080 -p 50001:50001 --env JENKINS_SLAVE_AGENT_PORT=50001 afischer211/jenkins
```
